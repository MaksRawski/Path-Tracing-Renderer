...
NFD_TARGET = $(LIB_BUILD_DIR)/nfd/src/libnfd.a
...
NFD_INCLUDE_DIR=nativefiledialog-extended/src/include

LIB_TARGETS = $(CIMGUI_TARGET) $(GLAD_TARGET) $(GLFW_TARGET) $(CGLTF_TARGET) $(stb_image_write_TARGET) $(NFD_TARGET)
LIB_INCLUDE_PATHS = $(CIMGUI_INCLUDE_DIR) $(GLAD_INCLUDE_DIR) $(GLFW_INCLUDE_DIR) $(CGLTF_INCLUDE_DIR) $(stb_image_write_INCLUDE_DIR) $(NFD_INCLUDE_DIR)
