...
bool test_YawPitch_from_PosLookat__by_default_look_at_negative_z_axis(void);
bool test_YawPitch_from_PosLookat__yaw_is_counter_clockwise__90_deg(void);
bool test_YawPitch_from_PosLookat__yaw_is_counter_clockwise__60_deg(void);
...
bool test_YawPitch_from_PosLookat__id(void);
